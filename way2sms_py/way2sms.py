...
if username is None: username = "9876543210"; #raw_input("Enter USERNAME: ")
if passwd is None: passwd = "password";#getpass()
if message is None: message = raw_input("Enter Message: ")
if number is None: number = "9876543210";#raw_input("Enter Mobile number: ")
